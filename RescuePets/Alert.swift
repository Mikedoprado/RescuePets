...
var alertList = [
    Alert(id: "jsjdnakkw", username: user1.username, userId: "ishdlae" , kindOfAlert: .Rescue, timestamp: 0, animal: .Cat, image: "helloImage", city: "Medellin", address: "Calle 13 # 43D - 79", description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque eget diam elementum, dictum leo quis, maximus velit. Donec tristique facilisis ipsum vitae lobortis.", isActive: true, mapImage: ""),
